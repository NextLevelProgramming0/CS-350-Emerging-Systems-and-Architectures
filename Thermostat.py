...
class TemperatureMachine(StateMachine):
    ...
    def updateLights(self):
        ...
        if self.heat.is_active:
            ...
            if temp > self.setPoint:
                ...
                blueLight.value = 1.0
        # No action needed for OFF -- LED already off above
    ...
    def manageMyDisplay(self):
        ...
        while not self.endDisplay:
            ...
            lcd_line_1 = lcd_line_1.ljust(16)[:16]  #  Ensure it fits display
    
            ## Setup Display Line 2
            if(altCounter < 6):
                lcd_line_2 = f"Temp: {floor(self.getFahrenheit())}F".ljust(16)[:16]
    
                altCounter = altCounter + 1
            else:
                lcd_line_2 = f"{self.current_state.id} @ {self.setPoint}F".ljust(16)[:16]
